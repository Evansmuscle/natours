...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZXZhbnNtdXNjbGUiLCJhIjoiY2tuYWo3cDNlMWh0YjJ1bngxdXVvMTZxayJ9.wfLVtShfQZRK05eUfDMtiw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/evansmuscle/cknajbahh3g6617qxhj35vcmf',
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Changed ".concat(type === 'password' ? 'password' : 'user info', " successfully!"));
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51IgFUtEXQ1qNTI1JtV7pxK44TECsMguEGTI8MwtW3P0ExGjLqBiQz0wZ3LqW5YFIumVMCgWjfDgm2T2Xt9XzhikH0042eI5WRI');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    console.log(form);
    (0, _updateSettings.updateSettings)(form, 'data'); // console.log(name, email);
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              document.getElementById('password-confirm').value = ''; // console.log(name, email);
